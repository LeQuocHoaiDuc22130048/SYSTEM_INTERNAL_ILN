...
/**
 * Export and print board QR codes with custom size, template, position, and formatting.
 * Executes direct printing via hidden iframe without opening new browser tabs.
 * Enforces strict user-configured @page dimensions.
 */
